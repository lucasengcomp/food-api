...
insert into restaurante (id, nome, taxa_frete, cozinha_id) values (1, 'Président', 10, 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id) values (2, 'Cão Velho', 9.50, 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id) values (3, 'Coco Bambu', 15, 2);
...
insert into cidade (id, nome, estado_id) values (5, 'Canaã dos Carajás', 3);
